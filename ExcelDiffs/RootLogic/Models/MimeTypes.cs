...
namespace RootLogic.Models
{
    public static class MimeTypes
    {
        ...
        public static string GetMimeTypeFromFileName(string fileName)
        {
            ...
            string mimeType = ContentTypes.FirstOrDefault(c => c.Key.ToLower() == extension.ToLower()).Value;
        ...
        {
            string mimeType = ContentTypes.FirstOrDefault(c => c.Key == extension).Value;
